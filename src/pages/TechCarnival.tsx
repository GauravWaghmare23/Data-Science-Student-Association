...
import techCarnivalImage from '../../public/Quest Winners.jpg';
    ...
    <div className="min-h-screen pt-20">
            ...
            {highlights.map((highlight, index) => {
              ...
              return (
                ...
                >
                  <CardHeader>
                    <div
                      className={`w-16 h-16 bg-gradient-${highlight} rounded-full flex items-center justify-center mx-auto mb-4`}
                    >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 justify-evenly">
