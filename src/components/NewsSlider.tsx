  ...
  return (
    <section className="py-20 bg-gradient-to-br from-background to-card/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Slider Section */}
        <div className="relative overflow-hidden rounded-xl cyber-card h-96">
          <div
          ...
          >
            {newsData.map((news, index) => (
              <div key={index} className="w-full flex-shrink-0 px-4 max-w-full">
          ...
          {newsData.slice(0, 6).map((news, index) => (
            ...
            >
              <div className="p-4">
                ...
                <h4 className="font-orbitron text-lg line-clamp-2">{news.title}</h4>
                <p className="text-muted-foreground line-clamp-3 mt-2">{news.description}</p>
              </div>
            </div>
          ))}
        </div>
